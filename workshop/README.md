...
We monitor the pasture areas in Lower Saxony. Using GPS telemetry, the system determines in real-time whether horses (e.g., Lilly or Honey) have left the predefined geofence.
